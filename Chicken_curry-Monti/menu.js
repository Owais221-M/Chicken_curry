...
function renderCart() {
  ...
  const hasPiccante = cart.some(i => i.name === "Piccante");
  const hasYoghurt = cart.some(i => i.name === "Yoghurt");
  ...
  if (!hasPiccante) appendUpsell("images/piccante.webp", "Need extra heat?", "Add Piccante Sauce", `'cross-sell-s1', 'Piccante',  0.50, 'sauce'`);
  if (!hasYoghurt) appendUpsell("images/yoghurt.webp", "Want it mild?", "Add Yoghurt Sauce", `'cross-sell-s2', 'Yoghurt', 0.50, 'sauce'`);
